...
export const ITEM_REGISTRY: Record<string, ItemDefinition> = {
  ...
  "flashlight": {
    ...
    rarity: "uncommon",
    tags: ["light", "tool"],
    usableOn: ["dark-passage", "dark-alcove", "hidden-panel", "lab-dark-corner"],
    combinesWith: [],
    useEffect: "The beam slices through the darkness. Numbers are scratched into the concrete: 4 · 7 · 2 · 9",
    consumeOnUse: false,
  },
  "keycard": {
    id: "keycard",
    ...
    rarity: "rare",
    tags: ["key", "electronic"],
    usableOn: ["card-reader", "security-door", "server-room", "lab-card-reader"],
    combinesWith: [],
  ...
  "screwdriver": {
    ...
    usableOn: ["vent-panel", "loose-screw", "pried-crate", "junction-box", "lab-vent"],
    combinesWith: ["wire"],
  ...
  "wire": {
    ...
    usableOn: ["junction-box", "broken-circuit", "lab-terminal-panel"],
  ...
  "lab-access-card": {
    ...
    shortName: "Lab Card",
    description: "A worn ID badge with 'DR. CHEN — RESEARCH LEAD' printed beneath a faded photo.",
    examineText: "The access card belongs to Dr. Chen, Research Lead. The holographic seal is still intact. Clearance Level: RESTRICTED. On the back, someone has written in marker: '0372'.",
    rarity: "rare",
    tags: ["key", "electronic"],
    usableOn: ["lab-security-door", "lab-card-reader"],
    combinesWith: [],
    useEffect: "The access card triggers the panel. It flashes — but the door won't open without the numeric code.",
    consumeOnUse: false,
  },
};
